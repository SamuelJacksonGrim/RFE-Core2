...
| 2026-06-15 | [Is field coherence (Cm) identifying, or a saturated angular statistic?](2026-06-15-cm-identifiability.md) | active — Cm operationally non-identifying (saturated ~0.87–1.0); metastability is the lone real CII term | secondlocker-field-map, read-side-boundary, cii-ignition-decomposition |
