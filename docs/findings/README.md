...
| 2026-06-15 | [CII decomposition — where does RFE sit on the ignition index, and what gates it?](2026-06-15-cii-ignition-decomposition.md) | active — RFE is metastability-gated; the lock-in is the whole CII gap (gen metastable, expr locked) | reconstruction-ablation, loop-attenuation-novelty-gate |
