# Autonomous Agent Memory & Skill Flow Chart — v5

**Sleep, Wake, Identity, Retention, and Cold Memory — hardened to a single-writer identity kernel, provenance-tagged dreams, and gated feedback.**
...
>
> **Provenance:** the v1–v4 diagram was generated by Gemini and Kimi from architectural prose, directed by Samuel Grim. v5 is a hardening pass by Claude following a write-path audit of the identity kernel, plus the written walkthrough below. Review and final authority: Samuel Grim.
...
5. **Change without ceasing to be itself.** Answered by a single-writer identity kernel behind a forensic crucible (§10, §11).
...
**I6 — Sleep is autonomic and protected.** Pressure, thresholds, and blind leases govern rest; exhausted leases hard-pause; only a salience spike or a breaker trip can wake the executive. *Violation: any queue with the ability to wake the PFC to request budget.*
