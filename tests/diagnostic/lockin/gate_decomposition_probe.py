"""
tests/diagnostic/lockin/gate_decomposition_probe.py
...
from tests.diagnostic.training.trained_generator_sim import TrainedGeneratorStub, DIM, VOCAB  # noqa: E402
