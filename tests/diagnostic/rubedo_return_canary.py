"""
tests/diagnostic/rubedo_return_canary.py
...
Run:  python -m tests.diagnostic.rubedo_return_canary [n_return_steps]
"""
...
from tests.diagnostic.coherence_diagnostic import (
